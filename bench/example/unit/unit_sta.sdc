...
# Removed -clock from set_input_transition
...
set_input_transition 0.30 -min -rise [get_ports inp2]
set_input_transition 0.30 -min -fall [get_ports inp2]
set_input_transition 0.40 -max -rise [get_ports inp2]
set_input_transition 0.40 -max -fall [get_ports inp2]

# Transition on clock port (removed -clock)
