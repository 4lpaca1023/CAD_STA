...
set_input_transition 0.10 -min -rise [get_ports inp1] -clock tau2015_clk
set_input_transition 0.15 -min -fall [get_ports inp1] -clock tau2015_clk
set_input_transition 0.20 -max -rise [get_ports inp1] -clock tau2015_clk
set_input_transition 0.25 -max -fall [get_ports inp1] -clock tau2015_clk

set_input_transition 0.30 -min -rise [get_ports inp2] -clock tau2015_clk
set_input_transition 0.30 -min -fall [get_ports inp2] -clock tau2015_clk
set_input_transition 0.40 -max -rise [get_ports inp2] -clock tau2015_clk
set_input_transition 0.40 -max -fall [get_ports inp2] -clock tau2015_clk

set_input_transition 0.10 -min -rise [get_ports tau2015_clk] -clock tau2015_clk
set_input_transition 0.15 -min -fall [get_ports tau2015_clk] -clock tau2015_clk
set_input_transition 0.10 -max -rise [get_ports tau2015_clk] -clock tau2015_clk
set_input_transition 0.15 -max -fall [get_ports tau2015_clk] -clock tau2015_clk
